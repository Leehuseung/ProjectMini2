...
@WebServlet("/view/restraunt/restraunt_updateForm.do")
public class RestrauntUpdateFormController extends HttpServlet{
	...
	RestrauntMapper mapper = MyAppSqlConfig.getSqlSession().getMapper(RestrauntMapper.class);
		...
		request.getRequestDispatcher("/view/restraunt/restraunt_update.jsp").forward(request, response);								
	}
}
