        ...
        <div class="container">
            ...
            <div class="photo">
                ...
                <div class="photoDetail">
                    <div><img id="img1" class="imgs"/></div>
                    <div><img id="img2" class="imgs"/></div>
                    <div><img id="img3" class="imgs"/></div>
                    <div><img id="img4" class="imgs"/></div>
                </div>
            </div>
                <div>
                       <span id=filediv><input type="file" name = "attach1" id="attach1"/></span>
                       <span id=filediv><input type="file" name = "attach2" id="attach2"/></span>
                       <span id=filediv><input type="file" name = "attach3" id="attach3"/></span>
                       <span id=filediv><input type="file" name = "attach4" id="attach4"/></span>
                   </form>
